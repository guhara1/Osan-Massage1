...
_breadcrumb_schema = {
    ...
    "@type": "BreadcrumbList",
    "itemListElement": [
        {"@type": "ListItem", "position": 1, "name": "홈", "item": _BASE + "/gyeonggi/osan/"}
    ],
}
...
_HERO = """<div class="hero">
  <div class="hero-content">
    ...
    <div class="hero-cta">
      ...
      <a href="/gyeonggi/osan/reservation/" class="btn btn-secondary">예약 안내 보기</a>
      <a href="/gyeonggi/osan/check/" class="btn btn-secondary">이용 전 확인사항</a>
    </div>
  </div>
...
<section id="criteria">
  ...
  <p>오산역 주변은 <a href="/gyeonggi/osan/jungang-dong/">중앙동</a>과 원동, 오산시청, 오산터미널 생활권과 연결됩니다. 오산 원도심의 상권과 행정 중심이 모여 있어 방문 수요가 가장 많이 형성되는 권역입니다. <a href="/gyeonggi/osan/station/osandae-station/">오산대역</a> 주변은 수청동과 세교 생활권 검색 의도가 강하며, 신축 오피스텔과 아파트 단지가 밀집해 있습니다.</p>
  <p><a href="/gyeonggi/osan/station/sema-station/">세마역</a> 주변은 세마동, 양산동, 지곶동, 북오산 생활권으로 잡습니다. <a href="/gyeonggi/osan/chopyeong-dong/">초평동</a>과 갈곶·고현 방향은 도심에서 다소 떨어져 있어 차량 이동 기준과 추가 이동비 확인이 특히 중요합니다. 예약 전에 자신의 주소가 어느 생활권에 속하고, 가장 가까운 역이 어디인지, 기본 이동권 범위에 포함되는지를 먼저 확인하면 예약 과정이 훨씬 원활해집니다.</p>
</section>

<section id="areas">
  <h2>오산 대표 지역별 방문 가능 지역 안내</h2>
  <div class="card-grid">
    <a href="/gyeonggi/osan/jungang-dong/" class="card">
      <h3>중앙동</h3>
      <p>오산역, 오산시청, 오산 원도심 인접 생활권</p>
    </a>
    <a href="/gyeonggi/osan/daewon-area/" class="card">
      <h3>대원 생활권</h3>
      <p>원동, 갈곶동, 고현동, 오산역 남부 인접권</p>
    </a>
    <a href="/gyeonggi/osan/namchon-dong/" class="card">
      <h3>남촌동</h3>
      <p>궐동, 청학동, 오산대역 인접 생활권</p>
    </a>
    <a href="/gyeonggi/osan/sinjang-area/" class="card">
      <h3>신장 생활권</h3>
      <p>수청동, 은계동, 내삼미동, 세교 생활권</p>
    </a>
    <a href="/gyeonggi/osan/sema-dong/" class="card">
      <h3>세마동</h3>
      <p>세마역, 양산동, 지곶동, 세교 북부 생활권</p>
    </a>
    <a href="/gyeonggi/osan/chopyeong-dong/" class="card">
      <h3>초평동</h3>
      <p>가장동, 서동, 누읍동, 갈곶·고현 인접 생활권</p>
    </a>
    <a href="/gyeonggi/osan/daewon-1-dong/" class="card">
      <h3>대원1동</h3>
      <p>오산역·원동 중심 생활권과 연결</p>
    </a>
    <a href="/gyeonggi/osan/daewon-2-dong/" class="card">
      <h3>대원2동</h3>
      <p>고현동·갈곶동·세교 남부 인접 생활권과 연결</p>
    </a>
    <a href="/gyeonggi/osan/sinjang-1-dong/" class="card">
      <h3>신장1동</h3>
      <p>수청동·은계동·오산대역 인접 생활권과 연결</p>
    </a>
    <a href="/gyeonggi/osan/sinjang-2-dong/" class="card">
      <h3>신장2동</h3>
...
<section id="stations">
  ...
  <div class="card-grid">
    <a href="/gyeonggi/osan/station/osan-station/" class="card">
      <h3>오산역</h3>
      <p>중앙동, 원동, 오산터미널 인접 생활권입니다. 방문 주소와 건물 출입 가능 여부를 먼저 확인하세요.</p>
    </a>
    <a href="/gyeonggi/osan/station/osandae-station/" class="card">
      <h3>오산대역</h3>
      <p>수청동, 세교, 남촌동 인접 생활권입니다. 자택·숙소·오피스텔 이용 가능 여부를 먼저 확인하세요.</p>
    </a>
    <a href="/gyeonggi/osan/station/sema-station/" class="card">
      <h3>세마역</h3>
      <p>세마동, 양산동, 지곶동 인접 생활권입니다. 차량 이동 기준과 추가 이동비 여부를 확인하세요.</p>
    </a>
    <a href="/gyeonggi/osan/station/byeongjeom-nearby-area/" class="card">
      <h3>병점역 인접</h3>
      <p>오산 북부 이동 기준 안내 (화성시 인접권)</p>
    </a>
    <a href="/gyeonggi/osan/station/seodongtan-nearby-area/" class="card">
      <h3>서동탄역 인접</h3>
      <p>세마·북오산 이동 기준 안내 (화성·오산 경계)</p>
    </a>
    <a href="/gyeonggi/osan/station/jinwi-nearby-area/" class="card">
      <h3>진위역 인접</h3>
...
<section id="lifestyle">
  ...
  <div class="card-grid">
    <a href="/gyeonggi/osan/area/osan-station-jungang/" class="card">오산역·중앙동</a>
    <a href="/gyeonggi/osan/area/osandae-sucheong/" class="card">오산대역·수청동</a>
    <a href="/gyeonggi/osan/area/sema-dong/" class="card">세마역·세마동</a>
    <a href="/gyeonggi/osan/area/segyeo-newtown/" class="card">세교신도시</a>
    <a href="/gyeonggi/osan/area/daewon-won-dong/" class="card">대원·원동</a>
    <a href="/gyeonggi/osan/area/namchon-gwol-dong/" class="card">남촌·궐동</a>
    <a href="/gyeonggi/osan/area/sinjang-sucheong/" class="card">신장·수청</a>
    <a href="/gyeonggi/osan/area/chopyeong-gajang/" class="card">초평·가장동</a>
    <a href="/gyeonggi/osan/area/galgot-gohyeon/" class="card">갈곶·고현</a>
    <a href="/gyeonggi/osan/area/osan-ic-logistics/" class="card">오산 IC·물류 인접</a>
  </div>
</section>

<section id="check">
  <h2>오산 홈타이 예약 전 확인사항</h2>
  <p>예약을 진행하기 전에 다음 항목들을 먼저 확인하면 예약 과정이 훨씬 수월합니다. 자세한 내용은 <a href="/gyeonggi/osan/check/">이용 전 확인사항</a> 페이지에서 확인하세요.</p>
  <ul>
